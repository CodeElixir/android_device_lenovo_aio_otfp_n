...
# Device
# OTA assert
TARGET_OTA_ASSERT_DEVICE := aio_otfp_m,aio_otfp,aio_5m,k50a40,K50a40,k50t5,K50t5.K50-t5
...
TARGET_KERNEL_CONFIG := aio_otfp_defconfig
...
#lenovo.sw.lily8.use smartpa start
CUSTOM_KERNEL_SOUND = 
#lenovo.sw.lily8.use smartpa end
...
#Lenovo-sw linyf modify 2015-11-24 18:28 , change for AIO 5M project.
#CUSTOM_MODEM = mt6752_k52_md1_lwg_dsds_combo_mp7_moly0017_prod mt6752_k52_md1_lttg_dsds_combo_mp7_moly0017_prod
...
#lenovo sw linyf, AIOM-849, modify for AIO 5M project, 2016-01-26
MTK_APP_GUIDE = no
...
#lenovo-sw heww3 disable audio profile begin
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.39_lenovo6752.65.m
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
MTK_CMAS_SUPPORT = no
#Begin lenovo-sw linyf, AIOM-848, modify for AIO 5M project.2016-01-25
...
# begin, lenovo-sw liyuan8 20151110
MTK_HOTKNOT_SUPPORT = no
# end, lenovo-sw liyuan8 20151110
...
#lenovo-sw wuwl10 20160126 modify for miravision
MTK_MIRAVISION_SETTING_SUPPORT = no
MTK_MLC_NAND_SUPPORT = no
MTK_MMPROFILE_SUPPORT = yes
MTK_MMUMAP_SUPPORT = no
#Lenovo-sw quebs2 modified 20151201 begin,close MTK default solution of permission control
MTK_MOBILE_MANAGEMENT = no
#Lenovo-sw quebs2 modified 20151201 end,close MTK default solution of permission control
...
MTK_NO_TRAN_ANIM = no
#lenovo-sw liuyc7 remove mtk_ntfs
...
#lenovo-sw fuxm1 2015.11.25 open for we use intsd as userdata partition begain
MTK_SHARED_SDCARD = yes
#lenovo-sw fuxm1 2015.11.25 open for we use intsd as userdata partition end
...
MTK_TEE_SUPPORT = no
#Begin lenovo-sw linyf, AIOM-848, modify for AIO 5M project.2016-01-25
MTK_TELEPHONY_BOOTUP_MODE_SLOT1 = 1
...
# Lenovo-sw guhong  close VOICE UNLOCK,  2015-10-27 begin
MTK_VOICE_INTERFACE_EXTENSION_SUPPORT = no
MTK_VOICE_UI_SUPPORT = no
MTK_VOICE_UNLOCK_SUPPORT = no
# Lenovo-sw guhong  close VOICE UNLOCK,  2015-10-27 end
...
#Lenovo-sw SW_SysApp_Settings_WLAN chencheng6 add 2015-10-26 begin ARIESM-200
MTK_WFD_SINK_SUPPORT = no
MTK_WFD_SINK_UIBC_SUPPORT = no
#Lenovo-sw SW_SysApp_Settings_WLAN chencheng6 add 2015-10-26 end ARIESM-200
MTK_WFD_SUPPORT = yes
...
#lenovo-sw.lily8.use external audio pa,2015-11-25
...
#CREATE_PROJECT_INFO=20160223185415
...
LENOVO_SHOW_LOW_BAT_UI_IN_LK_SUPPORT = yes
